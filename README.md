...
ユーザーの入力に基づいてAIが自動的に高品質なランディングページを生成するWebアプリケーションです。HTML、CSS、JavaScript、そして専用の画像まで、完全なランディングページを数分で作成できます。完成したページは、ダウンロード可能なZIPファイルとして提供されます。

<img width="1920" height="1018" alt="スクリーンショット 2025-07-21 173507" src="https://github.com/user-attachments/assets/cb0f3944-2f82-49be-81ab-72018bf9b137" />
